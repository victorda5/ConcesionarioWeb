...
<body>
    <nav class="navbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="customers.php" class="nav-link navbar-selected">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        <path
    ...
    <main>
        <section>
            <h1 class="section-title vehicles-sold-title">Customers</h1>
            <div class="table">
                <div class="car-card desktop" style="grid-template-columns: 1.5fr 1fr .5fr;">
                    <div class="car-stat">
                        <div class="car-img">
                            <span>USER</span>
                            <span>EMAIL</span>
                    ...
                    <div class="car-stat"><span>NAME</span></div>

                    <div class="car-stat"><span>REGION</span></div>
                </div>
                <?php
                displayUsers();
                ?>
