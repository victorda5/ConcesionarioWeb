...
<head>
    ...
    <title>Neukino Motors - Login</title>
</head>
            ...
            <div class="home__container container grid">
                <div class="box">
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="login-form">
                        ...
                        <input type="password" style="border-radius: 1rem" name="password" placeholder="Password" required>
                        <input type="submit" style="border: 0" name="submit" value="Login">
                        <div class="register-msg">
                            <pre>Dont have an account? Register <a href="register.php">here.</a></pre>
                        </div>
                    </form>
                </div>
            </div>
