...
<body>
    <nav class="navbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="sales.php" class="nav-link navbar-selected">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
    ...
    <main>
        ...
        ?>
            ...
            <h1 class="section-title vehicles-sold-title">Vehicles Sold</h1>
            <div class="table">
                <div class="car-card desktop">
                    ...
                    <div class="car-stat"><span>ORDER</span></div>
                    <div class="car-stat"><span>OWNER</span></div>
